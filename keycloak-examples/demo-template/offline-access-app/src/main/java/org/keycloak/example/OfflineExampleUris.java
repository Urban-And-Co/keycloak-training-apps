...
//            .queryParam("referrer", "offline-access-portal").build("demo").toString();
    ...
    public static final String ACCOUNT_MGMT = "http://localhost:8180/auth/realms/demo/account/applications?referrer=offline-access-portal";
...
//            .queryParam("redirect_uri", "/offline-access-portal").build("demo").toString();
    ...
    public static final String LOGOUT =
            "http://localhost:8180/auth/realms/demo/protocol/openid-connect/logout?redirect_uri=http://localhost:8080/offline-access-portal";
}
